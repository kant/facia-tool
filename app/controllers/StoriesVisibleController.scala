...
class StoriesVisibleController(val config: ApplicationConfiguration, val containers: Containers, override val wsClient: WSClient) extends Controller with PanDomainAuthActions {
